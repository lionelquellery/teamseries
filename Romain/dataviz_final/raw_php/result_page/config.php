<<<<<<< Updated upstream:Romain/dataviz/raw_php/result_page/config.php
<?php
...
if($serie_lenght > 445){
    $serie_overview = substr($serie->overview,0,445)."... <a href=".$serie->homepage.">see more</a>";
}else{
...
>>>>>>> Stashed changes:Romain/dataviz_final/raw_php/result_page/config.php
}